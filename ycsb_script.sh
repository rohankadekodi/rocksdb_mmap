...
setup_expt()
{
    ...
    #run_workload c $ycsbWorkloadsDir/runc_5M_5M $setup
    #$scriptsDir/pause_script.sh 10

    #sudo rm -rf $pmemDir/DR*

    #run_workload f $ycsbWorkloadsDir/runf_5M_10M $parameters $setup
    #$scriptsDir/pause_script.sh 10
